...
// RegisterGipfeliAuthServiceHandlerFromEndpoint is same as RegisterGipfeliAuthServiceHandler but
...
func RegisterGipfeliAuthServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterGipfeliAuthServiceHandler(ctx, mux, conn)
}

// RegisterGipfeliAuthServiceHandler registers the http handlers for service GipfeliAuthService to "mux".
...
func RegisterGipfeliAuthServiceHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	...
	mux.Handle("POST", pattern_GipfeliAuthService_GetUserInfo_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_GipfeliAuthService_GetUserInfo_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_GipfeliAuthService_GetUserInfo_0(ctx, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_GipfeliAuthService_GetUserInfo_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "auth"}, ""))
)

var (
	forward_GipfeliAuthService_GetUserInfo_0 = runtime.ForwardResponseMessage
)
